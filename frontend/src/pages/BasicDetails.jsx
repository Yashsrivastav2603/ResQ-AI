...
function BasicDetails() {
  ...
  const handleSubmit = (e) => {
    ...
    // City/state/postal go into the account's location alongside GPS
    // coordinates captured later — this way the geocoder has your typed
    // details even if the browser's coordinates land slightly off.
    mergeSignupDraft({
      city: form.city,
      state: form.state,
...
export default BasicDetails;import React, { useState } from "react";
import { useNavigate } from "react-router-dom";
import { mergeSignupDraft } from "../services/signupDraft";
